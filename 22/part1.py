...
initialisation_area = {"dimensions": [range(-50, 50 + 1)] * 3}
for step_num, step in enumerate(steps):
    steps[step_num]["dimensions"] = overlap(step, initialisation_area)
steps = [step for step in steps if step["dimensions"] is not None]
